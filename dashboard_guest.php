    ...
    <div class="l-navbar sidebar-custom" id="nav-bar">
        <nav class="nav">
            <div> <div class="nav_list">
                <a href="dashboard_guest.php" class="nav_link active"> <i class='bx bx-map nav_icon'></i> <span class="nav_name">Dashboard</span> </a>
                <a href="roulette_guest.php" class="nav_link"> <i class='bx bx-circle nav_icon'></i> <span class="nav_name">Users</span> </a>
                </div>
            </div> 

...
<body>
  <div class="l-navbar" id="nav-bar" style="background-color: #6414e9">
    <nav class="nav">
      <div>
        <div class="nav_list">
          <a href="dashboard_guest.php" class="nav_link"> <i class='bx bx-map nav_icon'></i> <span
              class="nav_name">Dashboard</span> </a>
          <a href="roulette_guest.php" class="nav_link active"> <i class='bx bx-circle nav_icon'></i> <span
        ...
        <tbody>
          ...
          while ($row = mysqli_fetch_assoc($query)) {
            echo "<tr>
                    ...
                    <td>" . $row['Alamat'] . "</td>
                    <td><a href='menu_guest.php?id=". $row['id_rm'] ."' class='btn btn-primary'>Show Menu</a>
                  </tr>";
          }
          ?>
        </tbody>
  ...
  for (let i of rotationValues) {
    ...
    if (angleValue >= i.minDegree && angleValue <= i.maxDegree) {
      ...
      let url = `eat_guest.php?id=${i.value}`;
